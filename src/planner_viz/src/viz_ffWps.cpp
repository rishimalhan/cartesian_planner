...
int main(int argc, char** argv){
    ros::init(argc,argv,"viz_ffWp");
    ros::NodeHandle wp_handler;
    ros::Subscriber wp_sub = wp_handler.subscribe<std_msgs::Bool>("cvrg_status",1000,cvrg_update);
    rviz_visual_tools::RvizVisualToolsPtr visual_tools_ (new rviz_visual_tools::RvizVisualTools("world","/ffWp"));
    visual_tools_->enableBatchPublishing(true);
    std::string path_path = "/home/rmalhan/Work/USC/Modules/cartesian_planning/cartesian_planner/src/pct/data/csv/ff_wps.csv";
