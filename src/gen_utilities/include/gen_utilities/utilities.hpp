...
public:
	...
	static std::vector<std::vector<int> > get_unique_rows(std::vector<std::vector<int> >);
	static std::vector<std::vector<float> > get_unique_rows(std::vector<std::vector<float> >);
	static std::vector<std::vector<double> > get_unique_rows(std::vector<std::vector<double> >);
