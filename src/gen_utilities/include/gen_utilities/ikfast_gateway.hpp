...
#include <gen_utilities/irb2600.cpp>
// #include <ur5.cpp>
// #include <gp8.cpp>
// #include <iiwa7.cpp>
// #include <irb4600.cpp>
...
namespace ik_analytical
{
	...
	static inline Eigen::Matrix4d compute_FK(Eigen::MatrixXd &_joint_config)
    {
    ...
    static inline void compute_IK(const Eigen::VectorXd &target, bool &bSuccess, Eigen::MatrixXd &sol_mat)
    {
        // IK
